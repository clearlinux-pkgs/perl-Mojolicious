...
Source0  : https://cpan.metacpan.org/authors/id/S/SR/SRI/Mojolicious-9.22.tar.gz
...
%prep
%setup -q -n Mojolicious-9.22
cd %{_builddir}/Mojolicious-9.22
...
cp %{_builddir}/Mojolicious-9.22/LICENSE %{buildroot}/usr/share/package-licenses/perl-Mojolicious/2f8018a02043ed1a43f032379e036bb6b88265f2
if test -f Makefile.PL; then
