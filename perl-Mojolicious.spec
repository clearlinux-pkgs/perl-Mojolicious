...
Source0  : https://cpan.metacpan.org/authors/id/S/SR/SRI/Mojolicious-9.35.tar.gz
...
%prep
%setup -q -n Mojolicious-9.35
cd %{_builddir}/Mojolicious-9.35
pushd ..
cp -a Mojolicious-9.35 buildavx2
popd
