...
Source0  : https://cpan.metacpan.org/authors/id/S/SR/SRI/Mojolicious-9.40.tar.gz
...
%prep
%setup -q -n Mojolicious-9.40
cd %{_builddir}/Mojolicious-9.40
pushd ..
cp -a Mojolicious-9.40 buildavx2
popd
