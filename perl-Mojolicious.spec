...
Source0  : https://cpan.metacpan.org/authors/id/S/SR/SRI/Mojolicious-9.38.tar.gz
...
%prep
%setup -q -n Mojolicious-9.38
cd %{_builddir}/Mojolicious-9.38
pushd ..
cp -a Mojolicious-9.38 buildavx2
popd
